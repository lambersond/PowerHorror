...
function linkPCFields(nodePS)
	...
	PartyManager.linkRecordField(nodeChar, nodePS, "abilities.power.score", "number", "power");
	PartyManager.linkRecordField(nodeChar, nodePS, "abilities.horror.score", "number", "horror");
	...
	PartyManager.linkRecordField(nodeChar, nodePS, "abilities.power.bonus", "number", "powbonus");
	PartyManager.linkRecordField(nodeChar, nodePS, "abilities.horror.bonus", "number", "horbonus");
