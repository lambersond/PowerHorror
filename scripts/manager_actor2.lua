...
function getAbilityScore(rActor, sAbility)
	...
	elseif sShort == "pow" then
		nStatScore = DB.getValue(nodeActor, "abilities.power.score", 0);
	elseif sShort == "hor" then
		nStatScore = DB.getValue(nodeActor, "abilities.horror.score", 0);
