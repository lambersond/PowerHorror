...
function evalAbilityHelper(rActor, sEffectAbility)
	...
	elseif sShortAbility == "POW" then
		nAbility = ActorManager2.getAbilityBonus(rActor, "power");
	elseif sShortAbility == "HOR" then
		nAbility = ActorManager2.getAbilityBonus(rActor, "horror");
